...
function Electrician() {
    const baseURL = "http://192.168.0.113:8080/users/electrician"
    const nearbyUsersUrl = "http://192.168.0.113:8080/users/electrician/outdistance"
    ...
    return (
        <div className="sub-pages-body">
            <div className="sub-page-cover-img electrician-cover-img"></div>
